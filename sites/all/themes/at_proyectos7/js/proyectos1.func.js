(function ($, Drupal, window, document, undefined) {
	...
	if(typeof pathArray[1] == "string" && pathArray[1] == "luis-roldan"){	
		if(typeof pathArray[3] == 'string'){
				...
				urlImage = "http://proyectos.banrepcultural.org/sites/default/files/fondos/"+pathArray[1]+"/inicio-luis-roldan.jpg",
				console.log(pathArray[3]);
		}
